...
To connect with external tools (Gmail, Calendar, Todoist, etc.), you'll need MCP (Model Context Protocol) connections. Skills handle workflows and templates; MCP handles live integrations.
